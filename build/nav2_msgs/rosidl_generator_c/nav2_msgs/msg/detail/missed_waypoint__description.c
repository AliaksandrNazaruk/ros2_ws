...
static char nav2_msgs__msg__MissedWaypoint__FIELD_NAME__index[] = "index";
static char nav2_msgs__msg__MissedWaypoint__FIELD_NAME__goal[] = "goal";
static char nav2_msgs__msg__MissedWaypoint__FIELD_NAME__error_code[] = "error_code";

static rosidl_runtime_c__type_description__Field nav2_msgs__msg__MissedWaypoint__FIELDS[] = {
  {
    {nav2_msgs__msg__MissedWaypoint__FIELD_NAME__index, 5, 5},
    {
  ...
  {
    {nav2_msgs__msg__MissedWaypoint__FIELD_NAME__goal, 4, 4},
    {
  ...
  {
    {nav2_msgs__msg__MissedWaypoint__FIELD_NAME__error_code, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription nav2_msgs__msg__MissedWaypoint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav2_msgs__msg__MissedWaypoint__FIELDS, 3, 3},
    },
    {nav2_msgs__msg__MissedWaypoint__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
nav2_msgs__msg__MissedWaypoint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav2_msgs__msg__MissedWaypoint__get_individual_type_description_source(NULL),
